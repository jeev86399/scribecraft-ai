    ...
    <div style={{ flex: 1, overflowY: 'auto', padding: '2rem 3rem', backgroundColor: 'var(--bg-app)' }}>
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
          Rephrase sentences, improve vocabulary, and adapt writing modes while preserving original meaning.
        </p>
      </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ fontWeight: 700, color: '#10b981' }}>Paraphrased Output ({selectedMode})</span>
            </div>
          ...
          <div style={{ flex: 1, padding: '1.25rem', height: '320px', overflowY: 'auto' }}>
            {!paraphrasedResult ? (
              <div style={{ height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: 'var(--text-muted)' }}>
                ...
                <p style={{ fontSize: '0.9rem' }}>Click <strong>Paraphrase</strong> to generate rewrites.</p>
              </div>
            ) : showDiff ? (
              renderDiffView()
            ) : (
